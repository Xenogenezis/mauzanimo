...
write('lib/screens/events/events_screen.dart', `import 'package:flutter/material.dart';
...
class EventsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Adoption Events')),
        ...
        builder: (context, snapshot) {
          ...
          if (docs.isEmpty)
            return Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              const Text('No upcoming events', style: TextStyle(color: Colors.grey, fontSize: 16)),
              const SizedBox(height: 8),
              const Text('Check back soon for adoption events near you.', style: TextStyle(color: Colors.grey, fontSize: 13)),
            ]));
                  ...
                  Padding(padding: const EdgeInsets.all(16), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Row(children: [
                      Container(
                        ...
                        child: const Text('Upcoming', style: TextStyle(fontSize: 11, color: AppTheme.primary, fontWeight: FontWeight.w600)),
                      ),
                    ]),
                    const SizedBox(height: 8),
