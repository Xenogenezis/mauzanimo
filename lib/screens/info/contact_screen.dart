  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(padding: const EdgeInsets.all(24), child: Column(
        ...
        children: [
          const Center(child: Icon(Icons.support_agent_outlined, size: 80, color: Colors.purple)),
          ...
          const _ContactTile(icon: Icons.email_outlined, color: AppTheme.primary,
            title: 'Email Us', subtitle: 'jcigrandbaie@gmail.com'),
          const SizedBox(height: 12),
          const _ContactTile(icon: Icons.phone_outlined, color: Colors.green,
            title: 'Call Us', subtitle: '+230 5704 7576'),
          const SizedBox(height: 12),
          const _ContactTile(icon: Icons.chat_outlined, color: Colors.blue,
            title: 'WhatsApp', subtitle: '+230 5704 7576'),
          const SizedBox(height: 12),
          const _ContactTile(icon: Icons.location_on_outlined, color: Colors.orange,
