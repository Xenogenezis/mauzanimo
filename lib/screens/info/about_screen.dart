  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(padding: const EdgeInsets.all(24), child: Column(
        ...
        children: [
          const Center(child: Icon(Icons.pets, size: 80, color: AppTheme.primary)),
          ...
          const SizedBox(height: 8),
          const Text('Mauzanimo is a digital adoption platform',
            style: TextStyle(fontSize: 14, color: Colors.grey, height: 1.6)),
          const SizedBox(height: 24),
          const Text('Our values',
            style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: AppTheme.textDark)),
          const SizedBox(height: 12),
          const _ValueTile(icon: Icons.favorite_outline, color: Colors.red, title: 'Compassion', description: 'Every animal matters'),
          const SizedBox(height: 8),
          const _ValueTile(icon: Icons.verified_outlined, color: AppTheme.primary, title: 'Transparency', description: 'Open and honest adoption process'),
          const SizedBox(height: 8),
          const _ValueTile(icon: Icons.groups_outlined, color: Colors.orange, title: 'Community', description: 'Building a kinder Mauritius together'),
          const SizedBox(height: 24),
