    ...
    children: [
      Container(
        ...
        child: const Row(children: [
          ...
          SizedBox(width: 12),
          Expanded(child: Text('List your pet for adoption and help them find a loving home.',
      ...
      SwitchListTile(
        title: const Text('Vaccinated'), value: _vaccinated,
        activeColor: AppTheme.primary, onChanged: (v) => setState(() => _vaccinated = v)),
      SwitchListTile(
        title: const Text('Sterilized'), value: _sterilized,
